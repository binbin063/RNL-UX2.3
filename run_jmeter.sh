...
#usage: nohup sh run_jmeter.sh --jmxFile ./jmeter-ux2.3/ux2.3_attachmentView_1.0.jmx --output ux2.3_attachmentView_3000 --propertyFile ./jmeter-ux2.3/test.properties --resdir /root/ux2.3-result/ux2.3-attachmentView-result/ux2.3-attachmentView-3000-result > test.log 2>&1 &
##set -x
